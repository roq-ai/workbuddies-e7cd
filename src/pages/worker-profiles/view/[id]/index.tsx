...
import { getWorkerProfileById } from 'apiSdk/worker-profiles';
...
function WorkerProfileViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('worker_profile', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/worker-profiles/edit/${data?.id}`} passHref legacyBehavior>
              <Button
          ...
          <>
            <Stack direction="column" spacing={2} mb={4}>
              ...
              <Flex alignItems="center">
                ...
                <Text fontSize="md" as="span" ml={3}>
                  {data?.availability as unknown as string}
                </Text>
              </Flex>
              <Flex alignItems="center">
                <Text fontSize="lg" fontWeight="bold" as="span">
              ...
              {hasAccess('application', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/applications/create?worker_profile_id=${data?.id}`}>
